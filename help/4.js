module.exports ={
    ...
    execute(message,args,Discord,msg){
       ...
       .addFields( 
            ...
            {name : "2. p!deadline-seriea" , value : `Gives Last Updated Deadline For serie A`},
            ...
            {name : "6. p!deadline-battleroyal" , value : `Gives Last Updated Deadline For Battle royal `}
