module.exports ={
    ...
    execute(message,args,Discord){
       ...
       .addFields(
           ...
           {name: "Rule 1" , value: ' Long balls from own half , Backpassing and kick off glitch are banned in the Tourneys , If Your Opponent Performs these Long balls and you concede a GOAL , You will Report recorded proof in #proves channel and THE FINAL DECISION WILL BE TAKEN BY THE STAFF MEMBERS And THAT SHOULD BE Respected . ONLY IF YOU Concede Goal by that , you can do Long ball but remember you must not score with that'},
