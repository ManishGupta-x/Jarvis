...
client.on('messageCreate', async message => {
    ...
    client.on('interactionCreate', async interaction => {
        ...
        if(interaction.isButton()){
            ...
            if(interaction.customId === 'skip'){ await interaction.reply({content: "Skipped", ephemeral: true, components : [row]})
            await  client.music.get('skip').execute(client, message, args, Discord);
                
            }else if(interaction.customId === 'BassBoost'){
                await  interaction.reply({content: "BassBoost Activated !", ephemeral: true, components : [row]})
                await client.music.get('bassboost').execute(client, message, args, Discord);
    
    
            }else if(interaction.customId === 'Nightcore'){
                await   interaction.reply({content: "Nightcore Activated !", ephemeral: true, components : [row]})
